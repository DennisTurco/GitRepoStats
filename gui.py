...
class GUI(ctk.CTk):
    ...
    def init_frame(self) -> None:
        ...
        label_start_date = ctk.CTkLabel(self, text="Start date (Optional):")
        label_start_date.grid(row=1, column=0, padx=10, pady=5, sticky="w")

        self.entry_start_date = ctk.CTkEntry(self, placeholder_text="DD-MM-YYYY")
        self.entry_start_date.grid(row=1, column=1, padx=(0, 10), pady=5, sticky="ew")

        label_end_date = ctk.CTkLabel(self, text="End date (Optional):")
        label_end_date.grid(row=2, column=0, padx=10, pady=5, sticky="w")

        self.entry_end_date = ctk.CTkEntry(self, placeholder_text="DD-MM-YYYY")
        self.entry_end_date.grid(row=2, column=1, padx=(0, 10), pady=5, sticky="ew")

        self.log_box = ctk.CTkTextbox(self)
        self.log_box.grid(row=3, column=0, columnspan=2, padx=10, pady=(10, 0), sticky="nsew")
        ...
        self.get_button.grid(row=4, column=0, columnspan=2, pady=15, sticky="n")
    ...
    def get_stats(self, repo_path: str, start_date, end_date) -> None:
        try:
            ...
            repo = RepoManagement(repo_path, self, period)
