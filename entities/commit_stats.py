...
class CommitStats():
    ...
    def __init__(self, name: str, author_name: str, files_edited: int, date: str):
        self.name = name
    ...
    def __str__(self) -> str:
        return f"Commit: {self.name}, Author: {self.author_name}, FilesEdited: {self.files_edited}, Date: {self.date}"

    def to_csv(self) -> str:
        return f"{self.name},{self.author_name},{self.files_edited},{self.date}"
