class Data():
    ...
    def __init__(self, repo_name: str, chart_authors_html: str, chart_files_html: str, chart_languages_html: str, chart_commits_html: str, chart_comulative_commits_html: str, chart_branches_html: str, chart_comulative_branches_html: str, csv_file_stats: list[str], csv_branches_stats: list[str]):
